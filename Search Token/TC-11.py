...
driver.find_element_by_id('com.ticktick.task:id/search_btn').click()
search_button = driver.find_element_by_id('com.ticktick.task:id/search_et')
search_button.click()
search_button.send_keys('task_1')
driver.find_element_by_id('com.ticktick.task:id/container').click()
driver.find_element_by_xpath("//android.support.v7.widget.RecyclerView/android.view.View").click()
print("done!")
